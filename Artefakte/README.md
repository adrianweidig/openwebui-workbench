...
Für lokale Windows-Arbeit kann dieser Containerpfad auf `E:\openwebui-workbench\Artefakte\output` gemountet werden. Die genaue Mount-Strategie steht in `Deployment/README.md`.
