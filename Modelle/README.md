...
- Modellprofile werden über `scripts/configure_openwebui_tool_models.py` vereinheitlicht: natives Tool-Calling, eingebettete Icons und High-Reasoning-Anweisung im Systemprompt. Feste Laufzeitparameter wie `max_tokens`, `temperature` und `top_p` werden bewusst nicht gesetzt; die Zielinstanz nutzt ihre Defaults.
