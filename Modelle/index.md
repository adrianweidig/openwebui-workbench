...
|---|---|---|---|
| `01_dokumentenanalyse.md` | Dokumentenanalyse | `dokumentenanalyse` | enabled |
| `02_dokumentenzusammenfassung.md` | Dokumentenzusammenfassung | `dokumentenzusammenfassung` | enabled |
...
| `10_codeanalyse.md` | Codeanalyse | `codeanalyse` | enabled |
| `11_code-review.md` | Code-Review | `code-review` | enabled |
...
| `19_anforderungsanalyse-lastenheft.md` | Anforderungsanalyse und Lastenheft | `anforderungsanalyse-lastenheft` | optional |
| `20_support-ticket-vorbereitung.md` | Support-Ticket-Vorbereitung | `support-ticket-vorbereitung` | optional |
