...
9. Die Chat-Modelle enthalten bereits Tool-/Filter-Zuordnung, eingebettete Icons, kurzen Bootstrap-Systemprompt, `meta.capabilities.builtin_tools: true`, Builtin-/Addon-Nutzungshinweise und `params.function_calling: "native"`; Mainprompt, Fachwissen und Beispielwissen werden als Knowledge verknüpft.
