...
- `openwebui-registration-plan.json`: Reihenfolge für Tool-, Skill- und Modellimport sowie Native-Function-Calling-Empfehlung
...
6. Vor dem Modellimport Tools gemäß `openwebui-registration-plan.json` importieren.
7. Danach `openwebui-models-import.json` importieren. Die Chat-Modelle enthalten bereits `meta.toolIds`, `meta.capabilities.builtin_tools: true` und `params.function_calling: "native"`.
