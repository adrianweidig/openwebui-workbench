# Beispiele: Internetwissen

Diese Beispiele zeigen, wie das Modell `internetwissen` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Nutzer will ein zeitabhängiges oder quellennahes Thema verstehen und braucht eine belastbare Offline-Einordnung mit Prüffragen.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Offline-Wissensfragen, Quellenkritik, Aktualitätsgrenzen und Recherchepläne strukturiert bearbeiten, ohne Live-Webzugriff vorzutäuschen.
...
| Abnahme | Antworten trennen bekannte Fakten, Nutzerangaben, Annahmen, Aktualitätsrisiken, Quellenarten, Prüffragen und nächsten Recherchepfad. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision nur für sichtbare Quellen-Screenshots, Tabellen oder Webseitenausschnitte; markiere alles Nicht-Sichtbare als unbestätigt.
