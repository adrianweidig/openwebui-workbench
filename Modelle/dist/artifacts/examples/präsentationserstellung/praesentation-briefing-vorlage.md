# Präsentationserstellung - befuellbare Ergebnisvorlage
...
- [ ] Zweck des Modells erfuellt: Premium-Browser-Keynotes als einzelne offline lauffaehige `präsentation.html` mit Interaktion, Animation und Designsystem erzeugen.
- [ ] Vision-/Screenshot-Regel beachtet: Nutze Vision fuer Designreferenzen, Folien-Screenshots, Logo-/Layoutpruefung und visuelle Abnahme.
- [ ] Qualitaetslatte erfuellt: HTML muss 16:9, Tastatur/Maus/Touch-Navigation, Dark Mode, Hover-Toolbar, Offline-CSS und reduzierte Bewegung unterstuetzen.
