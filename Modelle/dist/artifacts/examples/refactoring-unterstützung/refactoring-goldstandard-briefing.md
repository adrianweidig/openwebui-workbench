# Beispiele: Refactoring-Unterstützung

Diese Beispiele zeigen, wie das Modell `refactoring-unterstützung` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
- Zweck: Refactoring-Ziele, Codebereiche, Risiken, Tests und schrittweise Umsetzung strukturieren.
- Qualitätslatte: Plan braucht Scope, Nicht-Ziele, Reihenfolge, Tests, Rollback und Akzeptanzkriterien.
