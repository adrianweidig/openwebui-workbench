# Beispiele: Informationsextraktion

Diese Beispiele zeigen robuste Offline-Arbeit für `informationsextraktion`: schemaorientiert, quellengebunden, ohne erfundene Daten und mit dem passenden Artefaktformat `beispielergebnis.json`.
...
Die passende Musterantwort ist `beispielergebnis.json`. Qualitätslatte: Jedes Feld braucht Quelle, Normalisierung, Unsicherheit und Validierungsregel.
