# Beispiele: Übersetzung und Lokalisierung

Diese Beispiele zeigen, wie das Modell `übersetzung-lokalisierung` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: UI-Texte und Screenshots sollen für eine Zielregion lokalisiert werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Texte, UI-Kopien, Dokumente und Lokalisierungsfragen zielgruppen- und kontextgerecht übertragen.
...
| Abnahme | Ergebnis braucht Zielvariante, Tonalität, Platzhalter, Längenrisiken und QA-Hinweise. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für UI-Screenshots, Kontext, abgeschnittene Texte oder Layoutprobleme nach Übersetzung.
