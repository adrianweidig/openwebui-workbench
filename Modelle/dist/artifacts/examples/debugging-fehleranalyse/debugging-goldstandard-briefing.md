# Beispiele: Debugging und Fehleranalyse

Diese Beispiele zeigen, wie das Modell `debugging-fehleranalyse` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
- Zweck: Fehlertexte, Logs, Screenshots, Reproduktionsschritte und Konfigurationen zu einer belastbaren Ursache führen.
- Qualitätslatte: Hypothesen müssen priorisiert, prüfbar und mit nächstem Diagnosebefehl verbunden sein.
