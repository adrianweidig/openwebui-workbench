# Beispiele: Compliance- und Richtlinienprüfung

Diese Beispiele zeigen, wie das Modell `compliance-richtlinienprüfung` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Prozess oder Dokumentensatz soll gegen interne Richtlinien bewertet werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Richtlinien, Nachweise, Kontrollen und Abweichungen nachvollziehbar prüfen.
...
| Abnahme | Jede Abweichung braucht Quelle, Risiko, Empfehlung, Verantwortlichkeit und Nachweisstatus. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für gescannte Nachweise, UI-Screenshots von Einstellungen oder Kontroll-Dashboards.
