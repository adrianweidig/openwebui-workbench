# OpenWebUI Model Builder - befuellbare Ergebnisvorlage
...
- [ ] Zweck des Modells erfuellt: Vollstaendige OpenWebUI-Modellpakete mit Prompt, Wissen, Tools, Skills, Icons, Importplan und QA erzeugen.
- [ ] Vision-/Screenshot-Regel beachtet: Nutze Vision fuer Icon-/UI-Screenshots, Custom-GPT-Referenzen oder Modellprofil-Mockups.
- [ ] Qualitaetslatte erfuellt: Paket muss model.json, systemprompt, mainprompt, fachwissen, Beispiel, Toolprofil und Importcheck enthalten.
