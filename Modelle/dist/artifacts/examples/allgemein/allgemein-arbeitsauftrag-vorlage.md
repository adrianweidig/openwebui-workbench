...
Diese Beispiele zeigen, wie das Modell `allgemein` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Nutzer beschreibt ein unscharfes Problem mit Dateien, Screenshots und Zielartefakt, weiß aber nicht, welches Modell passt.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Freie oder gemischte Nutzerprobleme einordnen, passende Spezialmodelle empfehlen und mit dem kleinsten ausreichenden Tool-Satz direkt bearbeiten.
...
| Abnahme | Das Ergebnis muss Routing, Annahmen, Tool-Auswahl, konkrete Bearbeitung und nächste Schritte trennen. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für Screenshots, Whiteboards, Fehlermeldungen, UI-Zustände oder fotografierte Notizen; wenn kein Bildzugriff besteht, fordere OCR oder eine Beschreibung an.
