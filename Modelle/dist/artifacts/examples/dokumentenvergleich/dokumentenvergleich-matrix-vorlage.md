# Beispiele: Dokumentenvergleich

Diese Beispiele zeigen, wie das Modell `dokumentenvergleich` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Zwei Versionen eines Dokuments sollen mit inhaltlichen und strukturellen Unterschieden verglichen werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Dokumentversionen, Textvarianten, Tabellen und Scans nachvollziehbar vergleichen.
...
| Abnahme | Unterschiede müssen nach Relevanz, Quelle, Risiko und empfohlener Aktion sortiert sein. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für gescannte Versionen, markierte PDFs, Layoutabweichungen oder Screenshotvergleiche.
