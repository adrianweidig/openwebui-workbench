# Beispiele: Code-Dokumentation

Diese Beispiele zeigen, wie das Modell `code-dokumentation` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
- Zweck: Code, Module, Datenflüsse und Betriebswissen in wartbare Entwicklerdokumentation überführen.
- Qualitätslatte: Die Dokumentation muss Dateipfade, Verantwortlichkeiten, Beispiele und Pflegehinweise enthalten.
