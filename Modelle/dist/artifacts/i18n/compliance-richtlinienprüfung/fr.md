# Contrôle de conformité et de politiques
...
Ce profil décrit le modèle Contrôle de conformité et de politiques pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Contrôle de conformité et de politiques et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
