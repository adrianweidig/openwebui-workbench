# Preparação de relatórios e dashboards
...
Este perfil descreve o modelo Preparação de relatórios e dashboards para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Preparação de relatórios e dashboards e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
