...
Este perfil descreve o modelo Arquiteto de workflows n8n para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Arquiteto de workflows n8n e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
