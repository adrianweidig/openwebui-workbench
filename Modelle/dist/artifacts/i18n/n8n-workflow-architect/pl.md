...
Ten profil opisuje model Architekt workflow n8n do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Architekt workflow n8n i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
...
Ten profil jest przesyłany jako Knowledge razem z mainprompt.md, fachwissen.md, beispielergebnis.json i beispiele/.
