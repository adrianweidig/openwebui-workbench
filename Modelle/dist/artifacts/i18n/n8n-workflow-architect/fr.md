...
Ce profil décrit le modèle Architecte de workflows n8n pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Architecte de workflows n8n et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
