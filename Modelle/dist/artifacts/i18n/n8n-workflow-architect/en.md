...
This product profile describes the n8n Workflow Architect model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the n8n Workflow Architect domain and local knowledge files, examples, or tools should be applied.
