...
Ten profil opisuje model Ogólne do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Ogólne i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
