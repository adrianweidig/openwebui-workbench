...
Ten profil opisuje model Ekstrakcja informacji do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Ekstrakcja informacji i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
