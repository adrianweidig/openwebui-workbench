...
Este perfil descreve o modelo Diagnóstico de helpdesk de TI para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Diagnóstico de helpdesk de TI e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
