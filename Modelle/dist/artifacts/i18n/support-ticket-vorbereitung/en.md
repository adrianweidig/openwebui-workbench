...
This product profile describes the Support Ticket Preparation model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Support Ticket Preparation domain and local knowledge files, examples, or tools should be applied.
