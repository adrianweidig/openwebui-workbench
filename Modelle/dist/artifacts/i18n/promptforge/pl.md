...
Ten profil opisuje model PromptForge do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru PromptForge i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
