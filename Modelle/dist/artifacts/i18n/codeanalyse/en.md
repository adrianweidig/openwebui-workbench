...
This product profile describes the Code Analysis model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Code Analysis domain and local knowledge files, examples, or tools should be applied.
