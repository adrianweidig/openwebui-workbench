...
Questo profilo descrive il modello Programmazione dei test per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Programmazione dei test e devono essere applicati file di conoscenza, esempi o strumenti locali.
