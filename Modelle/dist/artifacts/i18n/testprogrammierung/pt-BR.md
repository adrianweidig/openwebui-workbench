...
Este perfil descreve o modelo Programação de testes para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Programação de testes e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
