...
Ten profil opisuje model Programowanie testów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Programowanie testów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
