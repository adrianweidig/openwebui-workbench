...
Ce profil décrit le modèle Programmation de tests pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Programmation de tests et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
