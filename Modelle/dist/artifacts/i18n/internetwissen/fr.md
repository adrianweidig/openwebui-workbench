...
Ce profil décrit le modèle Connaissances Internet pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Connaissances Internet et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
