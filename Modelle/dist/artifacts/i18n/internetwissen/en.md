...
This product profile describes the Internet Knowledge model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Internet Knowledge domain and local knowledge files, examples, or tools should be applied.
