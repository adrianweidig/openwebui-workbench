...
This product profile describes the Process and Workflow Documentation model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Process and Workflow Documentation domain and local knowledge files, examples, or tools should be applied.
