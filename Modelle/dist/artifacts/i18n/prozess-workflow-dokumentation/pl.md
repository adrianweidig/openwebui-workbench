# Dokumentacja procesów i workflow
...
Ten profil opisuje model Dokumentacja procesów i workflow do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Dokumentacja procesów i workflow i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
