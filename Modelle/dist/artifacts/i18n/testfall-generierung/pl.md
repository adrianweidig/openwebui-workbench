...
Ten profil opisuje model Generowanie przypadków testowych do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Generowanie przypadków testowych i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
