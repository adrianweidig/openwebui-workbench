...
Questo profilo descrive il modello Generazione di casi di test per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Generazione di casi di test e devono essere applicati file di conoscenza, esempi o strumenti locali.
