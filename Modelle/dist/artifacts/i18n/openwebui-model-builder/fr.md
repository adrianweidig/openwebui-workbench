# Générateur de modèles OpenWebUI
...
Ce profil décrit le modèle Générateur de modèles OpenWebUI pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Générateur de modèles OpenWebUI et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
