...
Ten profil opisuje model Analiza tabel i CSV do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Analiza tabel i CSV i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
