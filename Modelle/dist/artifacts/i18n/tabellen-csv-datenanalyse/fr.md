...
Ce profil décrit le modèle Analyse de tableaux et CSV pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Analyse de tableaux et CSV et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
