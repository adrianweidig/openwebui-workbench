...
This product profile describes the Translation and Localization model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Translation and Localization domain and local knowledge files, examples, or tools should be applied.
