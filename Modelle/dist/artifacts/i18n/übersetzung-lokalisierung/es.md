...
Este perfil describe el modelo Traducción y localización para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Traducción y localización y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
