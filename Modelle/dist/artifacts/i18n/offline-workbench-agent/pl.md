...
Ten profil opisuje model Agent Offline Workbench do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Agent Offline Workbench i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
