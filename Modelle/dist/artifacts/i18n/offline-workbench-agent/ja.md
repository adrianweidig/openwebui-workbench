...
このプロファイルは、日本語利用と多言語 OpenWebUI ワークフロー向けの オフライン Workbench エージェント モデルを説明します。

## 利用場面

依頼が オフライン Workbench エージェント の領域に合い、ローカルの Knowledge ファイル、例、ツールを適用する必要がある場合に使います。
