...
Ce profil décrit le modèle Agent Workbench hors ligne pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Agent Workbench hors ligne et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
