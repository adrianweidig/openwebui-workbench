...
Ce profil décrit le modèle Documentation du code pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Documentation du code et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
