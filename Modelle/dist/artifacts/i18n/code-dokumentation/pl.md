...
Ten profil opisuje model Dokumentacja kodu do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Dokumentacja kodu i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
