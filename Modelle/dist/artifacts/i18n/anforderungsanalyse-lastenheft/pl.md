...
Ten profil opisuje model Analiza wymagań i specyfikacja do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Analiza wymagań i specyfikacja i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
