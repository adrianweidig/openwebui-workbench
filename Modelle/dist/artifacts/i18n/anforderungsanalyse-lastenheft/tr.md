# Gereksinim analizi ve şartname
...
Bu profil, Gereksinim analizi ve şartname modelini Türkçe kullanım ve çok dilli OpenWebUI iş akışları için açıklar.

## Ne zaman kullanılır

İstek Gereksinim analizi ve şartname alanına uyduğunda ve yerel bilgi dosyaları, örnekler veya araçlar uygulanması gerektiğinde bu modeli kullan.
