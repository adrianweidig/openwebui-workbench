...
Questo profilo descrive il modello Analisi dei requisiti e specifica per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Analisi dei requisiti e specifica e devono essere applicati file di conoscenza, esempi o strumenti locali.
