# Migración de scripts de Eggplant a FlaUI
...
Este perfil describe el modelo Migración de scripts de Eggplant a FlaUI para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Migración de scripts de Eggplant a FlaUI y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
