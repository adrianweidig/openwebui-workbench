# Eggplant-to-FlaUI Script Migration
...
This product profile describes the Eggplant-to-FlaUI Script Migration model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Eggplant-to-FlaUI Script Migration domain and local knowledge files, examples, or tools should be applied.
