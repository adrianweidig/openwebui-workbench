...
Ce profil décrit le modèle Comparaison de documents pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Comparaison de documents et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
