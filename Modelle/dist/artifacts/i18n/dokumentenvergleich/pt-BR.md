...
Este perfil descreve o modelo Comparação de documentos para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Comparação de documentos e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
