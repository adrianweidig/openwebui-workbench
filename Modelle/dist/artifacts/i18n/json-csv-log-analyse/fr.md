...
Ce profil décrit le modèle Analyse JSON, CSV et logs pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Analyse JSON, CSV et logs et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
