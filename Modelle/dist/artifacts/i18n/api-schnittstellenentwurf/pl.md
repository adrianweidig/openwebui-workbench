...
Ten profil opisuje model Projektowanie API i interfejsów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Projektowanie API i interfejsów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
