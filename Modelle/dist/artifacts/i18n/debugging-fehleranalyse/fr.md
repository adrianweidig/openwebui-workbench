...
Ce profil décrit le modèle Débogage et analyse des erreurs pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Débogage et analyse des erreurs et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
