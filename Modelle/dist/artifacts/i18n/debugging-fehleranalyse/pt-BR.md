...
Este perfil descreve o modelo Depuração e análise de erros para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Depuração e análise de erros e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
