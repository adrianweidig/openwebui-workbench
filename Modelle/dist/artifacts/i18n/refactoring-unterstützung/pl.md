...
Ten profil opisuje model Wsparcie refaktoryzacji do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Wsparcie refaktoryzacji i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
