...
Este perfil descreve o modelo Suporte a refatoração para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Suporte a refatoração e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
