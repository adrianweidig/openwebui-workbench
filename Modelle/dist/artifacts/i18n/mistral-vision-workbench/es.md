...
Este perfil describe el modelo Mistral Vision Workbench para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Mistral Vision Workbench y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
