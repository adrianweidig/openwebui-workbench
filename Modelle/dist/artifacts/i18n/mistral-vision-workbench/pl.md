...
Ten profil opisuje model Mistral Vision Workbench do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Mistral Vision Workbench i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
