...
Ten profil opisuje model Analiza protokołów spotkań do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Analiza protokołów spotkań i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
