...
This product profile describes the Email and Communication Assistant model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Email and Communication Assistant domain and local knowledge files, examples, or tools should be applied.
