# Générateur de cas de test ISTQB
...
Ce profil décrit le modèle Générateur de cas de test ISTQB pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Générateur de cas de test ISTQB et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
