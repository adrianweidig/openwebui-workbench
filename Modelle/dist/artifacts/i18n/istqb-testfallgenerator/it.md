# Generatore di casi di test ISTQB
...
Questo profilo descrive il modello Generatore di casi di test ISTQB per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Generatore di casi di test ISTQB e devono essere applicati file di conoscenza, esempi o strumenti locali.
