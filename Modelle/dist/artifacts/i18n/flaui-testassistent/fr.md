...
Ce profil décrit le modèle Assistant de tests FlaUI pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Assistant de tests FlaUI et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
