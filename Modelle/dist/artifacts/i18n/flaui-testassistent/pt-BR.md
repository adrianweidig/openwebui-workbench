...
Este perfil descreve o modelo Assistente de testes FlaUI para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Assistente de testes FlaUI e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
