...
Questo profilo descrive il modello Assistente test FlaUI per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Assistente test FlaUI e devono essere applicati file di conoscenza, esempi o strumenti locali.
