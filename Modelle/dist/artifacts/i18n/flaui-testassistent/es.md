...
Este perfil describe el modelo Asistente de pruebas FlaUI para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Asistente de pruebas FlaUI y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
