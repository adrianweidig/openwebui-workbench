...
Ten profil opisuje model Asystent testów FlaUI do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Asystent testów FlaUI i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
