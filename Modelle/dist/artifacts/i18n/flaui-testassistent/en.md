...
This product profile describes the FlaUI Test Assistant model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the FlaUI Test Assistant domain and local knowledge files, examples, or tools should be applied.
