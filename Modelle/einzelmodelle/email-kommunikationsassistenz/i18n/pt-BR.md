# Assistente de e-mail e comunicação
...
Este perfil descreve o modelo Assistente de e-mail e comunicação para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Assistente de e-mail e comunicação e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
