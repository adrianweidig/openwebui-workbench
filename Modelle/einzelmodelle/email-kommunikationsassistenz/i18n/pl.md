...
Ten profil opisuje model Asystent poczty i komunikacji do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Asystent poczty i komunikacji i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
