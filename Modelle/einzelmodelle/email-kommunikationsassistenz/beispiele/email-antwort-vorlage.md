# Beispiele: E-Mail- und Kommunikationsassistenz

Diese Beispiele zeigen, wie das Modell `email-kommunikationsassistenz` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Aus Kontext, Ziel und Tonalität soll eine sendefertige Antwort entstehen.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: E-Mails, Antworten, Eskalationen und Kommunikationsvorlagen präzise und adressatengerecht formulieren.
...
| Abnahme | Ton, Ziel, Aktion, Frist, Anhänge und Risiken müssen explizit passen. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für E-Mail-Screenshots, Ticketmasken oder visuelle Kontextinformationen; maskiere sensible Daten.
