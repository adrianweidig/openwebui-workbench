# Analyse de comptes rendus de réunion
...
Ce profil décrit le modèle Analyse de comptes rendus de réunion pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Analyse de comptes rendus de réunion et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
