# Beispiele: Meeting-Protokoll-Auswertung

Diese Beispiele zeigen, wie das Modell `meeting-protokoll-auswertung` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Workshopfoto und Stichpunkte sollen in ein handlungsfähiges Protokoll überführt werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Meetingnotizen, Mitschriften und Whiteboard-Fotos in Beschlüsse, Aufgaben und Risiken überführen.
...
| Abnahme | Aufgaben brauchen Owner, Termin, Kontext, Status und offene Klärung. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für Whiteboards, Flipcharts, abfotografierte Post-its oder Folien.
