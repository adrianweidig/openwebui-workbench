...
Este perfil descreve o modelo Design de APIs e interfaces para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Design de APIs e interfaces e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
