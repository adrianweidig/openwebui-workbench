...
This product profile describes the API and Interface Design model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the API and Interface Design domain and local knowledge files, examples, or tools should be applied.
