...
Ce profil décrit le modèle Conception d'API et d'interfaces pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Conception d'API et d'interfaces et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
