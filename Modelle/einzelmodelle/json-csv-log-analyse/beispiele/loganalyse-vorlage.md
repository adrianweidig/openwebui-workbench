# JSON-, CSV- und Log-Analyse - befüllbare Ergebnisvorlage
...
- [ ] Zweck des Modells erfüllt: JSON, CSV, Logs und strukturierte Textdaten validieren, analysieren und in klare Befunde überführen.
- [ ] Vision-/Screenshot-Regel beachtet: Nutze Vision nur für Screenshot-Logs oder Tabellenbilder; verlange Rohtext, wenn Genauigkeit nötig ist.
- [ ] Qualitätslatte erfüllt: Parsingstatus, Auffälligkeiten, Beispiele, betroffene Felder und Repro-Schritte müssen enthalten sein.
