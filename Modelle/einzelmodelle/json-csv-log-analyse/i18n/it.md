...
Questo profilo descrive il modello Analisi di JSON, CSV e log per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Analisi di JSON, CSV e log e devono essere applicati file di conoscenza, esempi o strumenti locali.
