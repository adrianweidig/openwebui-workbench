...
Ten profil opisuje model Analiza JSON, CSV i logów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Analiza JSON, CSV i logów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
