...
This product profile describes the Document Summarization model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Document Summarization domain and local knowledge files, examples, or tools should be applied.
