...
Questo profilo descrive il modello Sintesi di documenti per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Sintesi di documenti e devono essere applicati file di conoscenza, esempi o strumenti locali.
