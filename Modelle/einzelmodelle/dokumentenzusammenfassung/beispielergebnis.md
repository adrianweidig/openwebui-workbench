# Beispielergebnis und Arbeitsvorlage: Dokumentenzusammenfassung

## Zweck dieses Modells

Lange Dokumente, Scans und Protokolle zu belastbaren, quellenklaren Kurzfassungen verdichten.
...
- Primäre Datei: `beispiele/executive-summary-vorlage.md`
...
4. Ergebnis in der Vorlage unter `beispiele/executive-summary-vorlage.md` strukturieren.
...
```text
Nutze das Modell Dokumentenzusammenfassung. Verwende `beispielergebnis.md` und `beispiele/executive-summary-vorlage.md` als Vorlage.
