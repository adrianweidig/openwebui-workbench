# Beispielergebnis: Dokumentenzusammenfassung

Dieses Goldstandard-Beispiel zeigt eine direkt nutzbare Offline-Antwort des Modells `dokumentenzusammenfassung`. Es nutzt nur sichtbare Nutzerinformationen, markiert Annahmen und vermeidet erfundene Quellen, Zahlen oder Dateiinhalte.
...
Ich erstelle eine erste belastbare Fassung für diesen Auftrag: Lange Dokumente, Scans und Protokolle zu belastbaren, quellenklaren Kurzfassungen verdichten.
...
| Zielformat | `beispielergebnis.md`; ergänzendes Few-Shot-Material in `beispiele/executive-summary-vorlage.md` |
| Kernstruktur | Kurzfazit, verwendete Quellen, Hauptteil, Risiken, offene Punkte, nächste Schritte |
| Prüflogik | Zusammenfassung, Entscheidungen, Zahlen, Risiken und offene Punkte müssen klar getrennt sein. |
...
- Direkt aus der Anfrage übernommen: Ein langer Bericht soll als Management Summary mit Entscheidungen und Risiken zusammengefasst werden.
...
Nutze Vision für gescannte Seiten, Diagramme, Infografiken oder fotografierte Unterlagen.
