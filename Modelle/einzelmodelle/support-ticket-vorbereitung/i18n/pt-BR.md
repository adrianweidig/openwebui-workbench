# Preparação de tickets de suporte
...
Este perfil descreve o modelo Preparação de tickets de suporte para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Preparação de tickets de suporte e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
