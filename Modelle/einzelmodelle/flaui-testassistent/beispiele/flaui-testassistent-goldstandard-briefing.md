# Beispiele: FlaUI-Testassistent

Diese Beispiele zeigen, wie das Modell `flaui-testassistent` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Nutzer benötigt ein prüfbares Ergebnis für den Aufgabenbereich `FlaUI-Testassistent` mit lokalem Kontext und optionalen Beispielen.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Das Modell `FlaUI-Testassistent` soll lokale Nutzeraufträge strukturiert, quellenbewusst und ohne erfundene Fakten bearbeiten.
