...
Questo profilo descrive il modello Analisi del codice per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Analisi del codice e devono essere applicati file di conoscenza, esempi o strumenti locali.
