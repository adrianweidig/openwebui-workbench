...
This product profile describes the Offline Workbench Agent model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Offline Workbench Agent domain and local knowledge files, examples, or tools should be applied.
