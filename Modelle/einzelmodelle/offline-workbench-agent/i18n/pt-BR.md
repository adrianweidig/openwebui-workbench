...
Este perfil descreve o modelo Agente Workbench offline para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Agente Workbench offline e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
