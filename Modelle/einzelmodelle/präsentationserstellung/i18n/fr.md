...
Ce profil décrit le modèle Création de présentations pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Création de présentations et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
...
Ce profil est téléversé comme Knowledge avec mainprompt.md, fachwissen.md, beispielergebnis.html et beispiele/.
