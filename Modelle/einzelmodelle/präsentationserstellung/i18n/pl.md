...
Ten profil opisuje model Tworzenie prezentacji do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Tworzenie prezentacji i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
