...
This product profile describes the Presentation Creation model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Presentation Creation domain and local knowledge files, examples, or tools should be applied.
...
This profile is uploaded as Knowledge together with mainprompt.md, fachwissen.md, beispielergebnis.html, and beispiele/.
