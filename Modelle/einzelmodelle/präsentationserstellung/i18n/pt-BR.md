...
Este perfil descreve o modelo Criação de apresentações para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Criação de apresentações e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
...
Este perfil é enviado como Knowledge junto com mainprompt.md, fachwissen.md, beispielergebnis.html e beispiele/.
