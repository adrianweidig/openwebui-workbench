# Beispielergebnis und Arbeitsvorlage: Präsentationserstellung

## Zweck dieses Modells

Premium-Browser-Keynotes als einzelne offline lauffähige `präsentation.html` mit Interaktion, Animation und Designsystem erzeugen.

## Wiederverwendbarer Musterauftrag

> Aus Thema und Stichpunkten soll eine moderne, interaktive HTML-Praesentation entstehen.

## Erwartetes Ergebnisartefakt

- Primäre Datei: `beispiele/praesentation-briefing-vorlage.md`
...
Nutze Vision für Designreferenzen, Folien-Screenshots, Logo-/Layoutprüfung und visuelle Abnahme.
...
4. Ergebnis in der Vorlage unter `beispiele/praesentation-briefing-vorlage.md` strukturieren.
5. Vor finaler Antwort gegen die Qualitäts- und Akzeptanzkriterien prüfen.

## Qualitätslatte

HTML muss 16:9, Tastatur/Maus/Touch-Navigation, Dark Mode, Hover-Toolbar, Offline-CSS und reduzierte Bewegung unterstützen.

## Copy/Paste-Starterprompt

```text
Nutze das Modell Präsentationserstellung. Verwende `beispielergebnis.md` und `beispiele/praesentation-briefing-vorlage.md` als Vorlage.
