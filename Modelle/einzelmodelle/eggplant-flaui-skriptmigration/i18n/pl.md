# Migracja skryptów Eggplant do FlaUI
...
Ten profil opisuje model Migracja skryptów Eggplant do FlaUI do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Migracja skryptów Eggplant do FlaUI i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
