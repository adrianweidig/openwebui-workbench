# Eggplant'tan FlaUI'ye betik geçişi
...
Bu profil, Eggplant'tan FlaUI'ye betik geçişi modelini Türkçe kullanım ve çok dilli OpenWebUI iş akışları için açıklar.

## Ne zaman kullanılır

İstek Eggplant'tan FlaUI'ye betik geçişi alanına uyduğunda ve yerel bilgi dosyaları, örnekler veya araçlar uygulanması gerektiğinde bu modeli kullan.
