# Migration de scripts Eggplant vers FlaUI
...
Ce profil décrit le modèle Migration de scripts Eggplant vers FlaUI pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Migration de scripts Eggplant vers FlaUI et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
