# Migração de scripts Eggplant para FlaUI
...
Este perfil descreve o modelo Migração de scripts Eggplant para FlaUI para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Migração de scripts Eggplant para FlaUI e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
