...
Dieses Goldstandard-Beispiel zeigt eine direkt nutzbare Offline-Antwort des Modells `eggplant-flaui-skriptmigration`. Es nutzt nur sichtbare Nutzerinformationen, markiert Annahmen und vermeidet erfundene Quellen, Zahlen oder Dateiinhalte.
...
Ich erstelle eine erste belastbare Fassung für diesen Auftrag: Das Modell `Eggplant-FlaUI-Skriptmigration` soll lokale Nutzeraufträge strukturiert, quellenbewusst und ohne erfundene Fakten bearbeiten.
...
| Zielformat | `beispielergebnis.md`; ergänzendes Few-Shot-Material in `beispiele/eggplant-flaui-skriptmigration-goldstandard-briefing.md` |
...
- Direkt aus der Anfrage übernommen: Ein Nutzer benötigt ein prüfbares Ergebnis für den Aufgabenbereich `Eggplant-FlaUI-Skriptmigration` mit lokalem Kontext und optionalen Beispielen.
