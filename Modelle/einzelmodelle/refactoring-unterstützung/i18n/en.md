...
This product profile describes the Refactoring Support model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Refactoring Support domain and local knowledge files, examples, or tools should be applied.
