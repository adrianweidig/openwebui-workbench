...
Questo profilo descrive il modello Supporto al refactoring per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Supporto al refactoring e devono essere applicati file di conoscenza, esempi o strumenti locali.
