...
Diese Beispiele zeigen, wie das Modell `code-review` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
- Zweck: Diffs, Risiken, Regressionen, Sicherheitsprobleme und fehlende Tests wie in einem professionellen Review priorisieren.
- Qualitätslatte: Findings stehen vor Zusammenfassung und referenzieren konkrete Dateien, Zeilen oder sichtbare UI-Zustände.
