# Beispiele: Testfall-Generierung

Diese Beispiele zeigen, wie das Modell `testfall-generierung` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
- Zweck: Aus Anforderungen, Code, UI-Screenshots und Risiken konkrete Testfälle und Akzeptanztests erzeugen.
- Qualitätslatte: Testfälle brauchen Preconditions, Schritte, Testdaten, erwartetes Ergebnis und Priorität.
