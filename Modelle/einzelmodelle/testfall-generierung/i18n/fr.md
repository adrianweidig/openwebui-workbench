...
Ce profil décrit le modèle Génération de cas de test pour l'usage en français et les workflows OpenWebUI multilingues.

## Utilisation

Utilise ce modèle lorsque la demande relève du domaine Génération de cas de test et que les fichiers de connaissance, exemples ou outils locaux doivent être appliqués.
