...
Este perfil descreve o modelo Geração de casos de teste para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Geração de casos de teste e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
