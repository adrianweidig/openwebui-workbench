...
This product profile describes the OpenWebUI Model Builder model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the OpenWebUI Model Builder domain and local knowledge files, examples, or tools should be applied.
