...
Ten profil opisuje model Kreator modeli OpenWebUI do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Kreator modeli OpenWebUI i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
