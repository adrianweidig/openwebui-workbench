...
This product profile describes the ISTQB Test Case Generator model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the ISTQB Test Case Generator domain and local knowledge files, examples, or tools should be applied.
