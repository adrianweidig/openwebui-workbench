# Generador de casos de prueba ISTQB
...
Este perfil describe el modelo Generador de casos de prueba ISTQB para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Generador de casos de prueba ISTQB y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
