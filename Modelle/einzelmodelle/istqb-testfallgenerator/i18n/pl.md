# Generator przypadków testowych ISTQB
...
Ten profil opisuje model Generator przypadków testowych ISTQB do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Generator przypadków testowych ISTQB i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
