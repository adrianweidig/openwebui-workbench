# Gerador de casos de teste ISTQB
...
Este perfil descreve o modelo Gerador de casos de teste ISTQB para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Gerador de casos de teste ISTQB e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
