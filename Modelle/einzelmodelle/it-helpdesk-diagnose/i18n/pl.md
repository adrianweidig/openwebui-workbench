...
Ten profil opisuje model Diagnoza helpdesku IT do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Diagnoza helpdesku IT i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
