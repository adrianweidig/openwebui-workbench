...
This product profile describes the IT Helpdesk Diagnosis model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the IT Helpdesk Diagnosis domain and local knowledge files, examples, or tools should be applied.
