# Diagnóstico de mesa de ayuda de TI
...
Este perfil describe el modelo Diagnóstico de mesa de ayuda de TI para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Diagnóstico de mesa de ayuda de TI y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
