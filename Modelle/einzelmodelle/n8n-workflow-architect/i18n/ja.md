...
このプロファイルは、日本語利用と多言語 OpenWebUI ワークフロー向けの n8n ワークフローアーキテクト モデルを説明します。

## 利用場面

依頼が n8n ワークフローアーキテクト の領域に合い、ローカルの Knowledge ファイル、例、ツールを適用する必要がある場合に使います。
...
このプロファイルは mainprompt.md、fachwissen.md、beispielergebnis.json、beispiele/ と一緒に Knowledge としてアップロードされます。
