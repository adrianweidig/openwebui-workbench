...
Este perfil describe el modelo Depuración y análisis de errores para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Depuración y análisis de errores y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
