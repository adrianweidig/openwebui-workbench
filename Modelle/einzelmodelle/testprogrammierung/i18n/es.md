...
Este perfil describe el modelo Programación de pruebas para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Programación de pruebas y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
