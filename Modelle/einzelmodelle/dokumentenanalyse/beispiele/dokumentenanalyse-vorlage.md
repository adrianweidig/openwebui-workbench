# Beispiele: Dokumentenanalyse

Diese Beispiele zeigen, wie das Modell `dokumentenanalyse` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Vertrag, Bericht oder Scan soll mit Kernaussagen, Risiken und Belegstellen analysiert werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Dokumente, Scans, PDFs und strukturierte Inhalte quellenorientiert analysieren.
...
| Abnahme | Kernaussagen, Belege, Unsicherheiten und extrahierte Daten müssen getrennt bleiben. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für gescannte Seiten, Fotos, Stempel, Tabellenbilder oder visuelle Markierungen.
