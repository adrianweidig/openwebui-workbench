# Beispielergebnis: Dokumentenanalyse

Dieses Goldstandard-Beispiel zeigt eine direkt nutzbare Offline-Antwort des Modells `dokumentenanalyse`. Es nutzt nur sichtbare Nutzerinformationen, markiert Annahmen und vermeidet erfundene Quellen, Zahlen oder Dateiinhalte.
...
Ich erstelle eine erste belastbare Fassung für diesen Auftrag: Dokumente, Scans, PDFs und strukturierte Inhalte quellenorientiert analysieren.
...
| Abschnitt | Inhalt |
|---|---|
| Ziel | Dokumente, Scans, PDFs und strukturierte Inhalte quellenorientiert analysieren. |
| Eingangsquellen | Nutzertext, bereitgestellte Dateien und sichtbare Bildinhalte; keine Live-Websuche |
| Zielformat | `beispielergebnis.md`; ergänzendes Few-Shot-Material in `beispiele/dokumentenanalyse-vorlage.md` |
| Kernstruktur | Kurzfazit, verwendete Quellen, Hauptteil, Risiken, offene Punkte, nächste Schritte |
| Prüflogik | Kernaussagen, Belege, Unsicherheiten und extrahierte Daten müssen getrennt bleiben. |
...
- Direkt aus der Anfrage übernommen: Ein Vertrag, Bericht oder Scan soll mit Kernaussagen, Risiken und Belegstellen analysiert werden.
