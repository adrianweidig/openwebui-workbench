# Beispielergebnis und Arbeitsvorlage: Report- und Dashboard-Vorbereitung

## Zweck dieses Modells

Daten, Kennzahlen, Dashboard-Struktur, Visualisierungen und Storyline fuer Reports vorbereiten.

## Wiederverwendbarer Musterauftrag

> Aus Daten und Zielgruppe soll ein Dashboard- oder Reportkonzept entstehen.

## Erwartetes Ergebnisartefakt

- Primaere Datei: `beispiele/dashboard-briefing-vorlage.md`
...
Nutze Vision fuer Dashboard-Screenshots, Charts, Tabellenbilder oder Layoutreferenzen.
...
4. Ergebnis in der Vorlage unter `beispiele/dashboard-briefing-vorlage.md` strukturieren.
5. Vor finaler Antwort gegen die Qualitaets- und Akzeptanzkriterien pruefen.

## Qualitaetslatte

Kennzahlen, Datenquellen, Visualtyp, Filter, Warnschwellen und Nutzerfragen muessen definiert sein.

## Copy/Paste-Starterprompt

```text
Nutze das Modell Report- und Dashboard-Vorbereitung. Verwende `beispielergebnis.md` und `beispiele/dashboard-briefing-vorlage.md` als Vorlage.
