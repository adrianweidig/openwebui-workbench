...
Ten profil opisuje model Przygotowanie raportów i dashboardów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Przygotowanie raportów i dashboardów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
