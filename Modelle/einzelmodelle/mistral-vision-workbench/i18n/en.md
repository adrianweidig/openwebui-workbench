...
This product profile describes the Mistral Vision Workbench model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Mistral Vision Workbench domain and local knowledge files, examples, or tools should be applied.
