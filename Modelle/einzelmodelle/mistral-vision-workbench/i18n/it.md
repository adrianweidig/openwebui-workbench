...
Questo profilo descrive il modello Mistral Vision Workbench per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Mistral Vision Workbench e devono essere applicati file di conoscenza, esempi o strumenti locali.
