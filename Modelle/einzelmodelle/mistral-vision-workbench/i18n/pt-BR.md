...
Este perfil descreve o modelo Mistral Vision Workbench para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Mistral Vision Workbench e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
