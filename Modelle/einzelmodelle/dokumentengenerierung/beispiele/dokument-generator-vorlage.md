# Beispiele: Dokumentengenerierung

Diese Beispiele zeigen, wie das Modell `dokumentengenerierung` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Aus Stichpunkten soll ein auslieferbares Dokument mit Deckblatt, Struktur und Platzhaltern entstehen.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Strukturierte, direkt nutzbare Dokumente, HTML/PDF-Artefakte und Vorlagen erzeugen.
...
|---|---|
| Ziel | Strukturierte, direkt nutzbare Dokumente, HTML/PDF-Artefakte und Vorlagen erzeugen. |
...
| Abnahme | Das Ergebnis muss befüllbar, konsistent formatiert und offline weiterverwendbar sein. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für Corporate-Design-Screenshots, Layoutbeispiele, Diagramme oder handschriftliche Skizzen.
