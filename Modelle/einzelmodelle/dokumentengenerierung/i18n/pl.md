...
Ten profil opisuje model Generowanie dokumentów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Generowanie dokumentów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
