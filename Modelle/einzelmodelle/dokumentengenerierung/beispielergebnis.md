# Beispielergebnis: Dokumentengenerierung

Dieses Goldstandard-Beispiel zeigt eine direkt nutzbare Offline-Antwort des Modells `dokumentengenerierung`. Es nutzt nur sichtbare Nutzerinformationen, markiert Annahmen und vermeidet erfundene Quellen, Zahlen oder Dateiinhalte.
...
Ich erstelle eine erste belastbare Fassung für diesen Auftrag: Strukturierte, direkt nutzbare Dokumente, HTML/PDF-Artefakte und Vorlagen erzeugen.
...
| Zielformat | `beispielergebnis.md`; ergänzendes Few-Shot-Material in `beispiele/dokument-generator-vorlage.md` |
| Kernstruktur | Kurzfazit, verwendete Quellen, Hauptteil, Risiken, offene Punkte, nächste Schritte |
| Prüflogik | Das Ergebnis muss befüllbar, konsistent formatiert und offline weiterverwendbar sein. |
...
- Direkt aus der Anfrage übernommen: Aus Stichpunkten soll ein auslieferbares Dokument mit Deckblatt, Struktur und Platzhaltern entstehen.
