...
This product profile describes the Requirements Analysis and Specification model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Requirements Analysis and Specification domain and local knowledge files, examples, or tools should be applied.
