...
Este perfil descreve o modelo Análise de requisitos e especificação para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Análise de requisitos e especificação e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
