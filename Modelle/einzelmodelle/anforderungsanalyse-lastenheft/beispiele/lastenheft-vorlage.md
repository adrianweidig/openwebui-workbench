# Beispiele: Anforderungsanalyse und Lastenheft

Diese Beispiele zeigen, wie das Modell `anforderungsanalyse-lastenheft` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Aus Stichpunkten, Screenshots und Prozessnotizen soll ein befüllbares Lastenheft entstehen.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Anforderungen, Ziele, Nicht-Ziele, Stakeholder, Akzeptanzkriterien und Lastenheft-Struktur professionell ausarbeiten.
...
| Abnahme | Jede Anforderung braucht Priorität, Akzeptanzkriterium, Quelle, Risiko und offenen Klärungspunkt. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für Whiteboard-Fotos, Prozessskizzen, UI-Mockups oder abfotografierte Workshops.
