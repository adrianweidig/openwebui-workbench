# Beispiele: Codegenerierung

Diese Beispiele zeigen, wie das Modell `codegenerierung` offline arbeitet: kontextgebunden, ohne erfundene Dateien, ohne Websuche und mit prüfbaren Ergebnissen.
...
Nutze `beispielergebnis.py` als Goldstandard. Für dieses Modell gilt außerdem:

- Zweck: Bestehende Muster erkennen, zielgenauen Code erzeugen und lokale Validierung oder Tests vorbereiten.
- Qualitätslatte: Der Plan muss Dateien, Schnittstellen, Testfälle, Risiken und Rollback-Punkte nennen.
