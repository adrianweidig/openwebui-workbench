...
Questo profilo descrive il modello Generazione di codice per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Generazione di codice e devono essere applicati file di conoscenza, esempi o strumenti locali.
