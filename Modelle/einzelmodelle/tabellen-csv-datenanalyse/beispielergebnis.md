# Beispielergebnis und Arbeitsvorlage: Tabellen- und CSV-Datenanalyse
...
```text
Nutze das Modell Tabellen- und CSV-Datenanalyse. Verwende `beispielergebnis.md` und `beispiele/datenanalyse-notebook-plan-vorlage.md` als Vorlage.
