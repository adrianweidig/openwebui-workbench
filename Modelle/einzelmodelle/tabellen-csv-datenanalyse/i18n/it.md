...
Questo profilo descrive il modello Analisi di tabelle e CSV per l'uso in italiano e per workflow OpenWebUI multilingue.

## Quando usarlo

Usa questo modello quando la richiesta rientra nell'ambito Analisi di tabelle e CSV e devono essere applicati file di conoscenza, esempi o strumenti locali.
