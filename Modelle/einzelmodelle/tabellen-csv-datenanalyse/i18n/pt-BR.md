...
Este perfil descreve o modelo Análise de tabelas e CSV para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Análise de tabelas e CSV e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
