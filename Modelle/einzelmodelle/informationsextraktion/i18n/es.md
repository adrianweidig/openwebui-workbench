...
Este perfil describe el modelo Extracción de información para uso en español y flujos multilingües de OpenWebUI.

## Uso recomendado

Usa este modelo cuando la solicitud corresponda al ámbito Extracción de información y deban aplicarse archivos de conocimiento, ejemplos o herramientas locales.
