...
This product profile describes the Information Extraction model for English usage and multilingual OpenWebUI workflows.

## When to Use

Use this model when the request fits the Information Extraction domain and local knowledge files, examples, or tools should be applied.
