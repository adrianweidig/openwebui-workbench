...
Este perfil descreve o modelo Extração de informações para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Extração de informações e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
