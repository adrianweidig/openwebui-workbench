...
Ten profil opisuje model Porównanie dokumentów do użycia po polsku i w wielojęzycznych przepływach OpenWebUI.

## Kiedy używać

Użyj tego modelu, gdy żądanie pasuje do obszaru Porównanie dokumentów i należy zastosować lokalne pliki wiedzy, przykłady lub narzędzia.
