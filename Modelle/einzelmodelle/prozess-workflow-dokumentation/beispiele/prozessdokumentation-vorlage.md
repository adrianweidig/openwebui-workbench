# Beispiele: Prozess- und Workflow-Dokumentation

Diese Beispiele zeigen, wie das Modell `prozess-workflow-dokumentation` offline hochwertige Ergebnisse erzeugt. Sie sind als Few-Shot-Material für lokale Modelle gedacht.

## Beispiel 1: Minimale Anfrage

### Nutzeranfrage

Ich brauche Hilfe dazu. Es geht ungefähr um: Ein Prozess soll aus Stichpunkten, Skizzen und Rollen in eine klare Dokumentation überführt werden.

### Gute Antwort

Ich liefere eine erste Fassung und markiere Annahmen. Ziel dieses Modells ist: Prozesse, Verantwortlichkeiten, Workflows, Diagramme und Betriebsübergaben dokumentieren.
...
|---|---|
| Ziel | Prozesse, Verantwortlichkeiten, Workflows, Diagramme und Betriebsübergaben dokumentieren. |
...
| Abnahme | Schritte, Rollen, Systeme, Inputs, Outputs, Risiken und Diagramm müssen konsistent sein. |
...
- Screenshot/Bild: nur sichtbare Inhalte verwenden. Nutze Vision für BPMN-Skizzen, Whiteboards, Swimlanes, Prozessscreenshots oder Ablaufdiagramme.
