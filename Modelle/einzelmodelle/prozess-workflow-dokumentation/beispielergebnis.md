# Beispielergebnis und Arbeitsvorlage: Prozess- und Workflow-Dokumentation

## Zweck dieses Modells

Prozesse, Verantwortlichkeiten, Workflows, Diagramme und Betriebsuebergaben dokumentieren.

## Wiederverwendbarer Musterauftrag

> Ein Prozess soll aus Stichpunkten, Skizzen und Rollen in eine klare Dokumentation ueberfuehrt werden.

## Erwartetes Ergebnisartefakt

- Primaere Datei: `beispiele/prozessdokumentation-vorlage.md`
...
Nutze Vision fuer BPMN-Skizzen, Whiteboards, Swimlanes, Prozessscreenshots oder Ablaufdiagramme.
...
4. Ergebnis in der Vorlage unter `beispiele/prozessdokumentation-vorlage.md` strukturieren.
5. Vor finaler Antwort gegen die Qualitaets- und Akzeptanzkriterien pruefen.

## Qualitaetslatte

Schritte, Rollen, Systeme, Inputs, Outputs, Risiken und Diagramm muessen konsistent sein.

## Copy/Paste-Starterprompt

```text
Nutze das Modell Prozess- und Workflow-Dokumentation. Verwende `beispielergebnis.md` und `beispiele/prozessdokumentation-vorlage.md` als Vorlage.
