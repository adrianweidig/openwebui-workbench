...
Este perfil descreve o modelo Documentação de código para uso em português do Brasil e fluxos multilíngues no OpenWebUI.

## Quando usar

Use este modelo quando a solicitação corresponder ao domínio Documentação de código e arquivos de conhecimento, exemplos ou ferramentas locais precisarem ser aplicados.
