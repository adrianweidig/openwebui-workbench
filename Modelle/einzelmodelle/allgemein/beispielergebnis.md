...
> Ein Nutzer beschreibt ein unscharfes Problem mit Dateien, Screenshots und Zielartefakt, weiss aber nicht, welches Modell passt.

## Erwartetes Ergebnisartefakt

- Primaere Datei: `beispiele/allgemein-arbeitsauftrag-vorlage.md`
...
Nutze Vision fuer Screenshots, Whiteboards, Fehlermeldungen, UI-Zustaende oder fotografierte Notizen; wenn kein Bildzugriff besteht, fordere OCR oder eine Beschreibung an.
...
Das Ergebnis muss Routing, Annahmen, Tool-Auswahl, konkrete Bearbeitung und naechste Schritte trennen.
