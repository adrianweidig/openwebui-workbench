...
| `Tools/openwebui_ext/tools/openui_generative_ui.py` | CDN-Basis für OpenUI | 3 | generiertes HTML kann CDN laden | nicht Offline-Default | Nicht `internetwissen` zuweisen; Offline-Artefakte mit Vanilla HTML/CSS/JS bevorzugen |
...
Der Offline-Default bleibt ohne öffentliche Runtime-Websuche. Netzwerkfähige Tools sind optional, dokumentiert und dürfen nicht automatisch Modellprofilen wie `internetwissen` zugewiesen werden. Externe Container-Images werden als Release-/Deployment-Thema behandelt; für Air-Gap-Nutzung sind lokale Image-Tars mit Hashes vorgesehen.
