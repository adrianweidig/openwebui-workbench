...
MESSAGES: dict[str, dict[str, str]] = {
    "de": {
        ...
        "only_model_markdown": "Nur freigegebene Text- und HTML-Dateien eines Modellpakets dürfen bearbeitet werden.",
    ...
    "en": {
        ...
        "only_model_markdown": "Only approved text and HTML files inside a model package can be edited.",
