...
MESSAGES: dict[str, dict[str, str]] = {
    "de": {
        ...
        "auth_required_for_non_loopback": "WORKBENCH_AUTH_USERNAME und WORKBENCH_AUTH_PASSWORD oder WORKBENCH_AUTH_PASSWORD_FILE müssen gesetzt sein, wenn das Dashboard nicht nur an Loopback gebunden wird.",
        "auth_required_for_runtime": "WORKBENCH_AUTH_USERNAME und WORKBENCH_AUTH_PASSWORD oder WORKBENCH_AUTH_PASSWORD_FILE müssen gesetzt sein, wenn WORKBENCH_REQUIRE_AUTH=true ist.",
        "content_too_large": "Dateiinhalt ist größer als {max_bytes} Bytes.",
        "csrf_required": "Schreibende Dashboard-Anfragen benötigen den Workbench-Same-Origin-Header.",
        ...
        "invalid_model_settings": "Modell-Einstellungen müssen ein JSON-Objekt sein.",
        "model_settings_id_mismatch": "Modell-Einstellungen dürfen die Modell-ID nicht von {expected} auf {actual} ändern.",
        ...
        "model_selection_empty": "Keine Modelle ausgewählt.",
        "only_model_markdown": "Nur freigegebene Modell- und Beispielartefakte dürfen bearbeitet werden.",
        "request_too_large": "Request ist größer als {max_bytes} Bytes.",
        "resource_exists": "Ressource existiert bereits: {resource_id}",
        "resource_not_found": "Ressource nicht gefunden: {kind}/{resource_id}",
        "resource_selection_empty": "Keine Ressourcen ausgewählt.",
        "resource_type": "Ressourcentyp muss `tool`, `function`, `skill` oder `prompt` sein.",
    ...
    "en": {
        ...
        "auth_required_for_non_loopback": "WORKBENCH_AUTH_USERNAME and WORKBENCH_AUTH_PASSWORD or WORKBENCH_AUTH_PASSWORD_FILE must be set when the dashboard is not bound to loopback only.",
        "auth_required_for_runtime": "WORKBENCH_AUTH_USERNAME and WORKBENCH_AUTH_PASSWORD or WORKBENCH_AUTH_PASSWORD_FILE must be set when WORKBENCH_REQUIRE_AUTH=true.",
        "content_too_large": "File content is larger than {max_bytes} bytes.",
        "csrf_required": "Mutating dashboard requests require the Workbench same-origin header.",
        ...
        "invalid_model_settings": "Model settings must be a JSON object.",
        "model_settings_id_mismatch": "Model settings must not change the model ID from {expected} to {actual}.",
        ...
        "model_selection_empty": "No models selected.",
        "only_model_markdown": "Only approved model and example artifacts can be edited.",
        "request_too_large": "Request is larger than {max_bytes} bytes.",
        "resource_exists": "Resource already exists: {resource_id}",
        "resource_not_found": "Resource not found: {kind}/{resource_id}",
        "resource_selection_empty": "No resources selected.",
        "resource_type": "Resource type must be `tool`, `function`, `skill`, or `prompt`.",
