...
class Tools:
    ...
    class Valves(BaseModel):
        ...
        ENABLE_WEB_TOOLS: bool = Field(
            default=False,
            description="Air-gap default: disabled. Enable only when OpenWebUI web tools point to local/self-hosted sources.",
        )
        ENABLE_IMAGE_TOOLS: bool = Field(
            default=False,
            description="Air-gap default: disabled. Enable only when image generation is backed by local models/endpoints.",
        )
        ...
        ENABLE_AUTOMATION_TOOLS: bool = Field(
            default=False,
            description="Air-gap default: disabled unless local OpenWebUI automation policy explicitly allows it.",
        )
        ENABLE_CALENDAR_TOOLS: bool = Field(
            default=False,
            description="Air-gap default: disabled because calendar connectors often require external services.",
        )
